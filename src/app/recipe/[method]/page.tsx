                    ...
                    <div className={form.className} key={crypto.randomUUID()}>
                      ...
                      <div className="mt-2 md:grid md:grid-cols-2 gap-2">
                        <TextField
                          ...
                          label="Horas"
                          error={
                            errors && !!errors[(form.name + "Hours") as string]
                          }
                          helperText={
                            errors &&
                            (errors[(form.name + "Hours") as string]
                              ?.message as string)
                          }
                          fullWidth
                          defaultValue={
                            recipe[(form.name + "Hours") as keyof RecipeType]
                          }
                          {...register(
                            (form.name + "Hours") as string,
                            form.validates
                          )}
                          onChange={() => {}}
                        />
                        <TextField
                          ...
                          error={
                            errors &&
                            !!errors[(form.name + "Minutes") as string]
                          }
                          helperText={
                            errors &&
                            (errors[(form.name + "Minutes") as string]
                          ...
                          defaultValue={
                            recipe[(form.name + "Minutes") as keyof RecipeType]
                          }
                          {...register(
                            (form.name + "Minutes") as string,
                            form.validates
                          )}
                          onChange={() => {}}
                        />
