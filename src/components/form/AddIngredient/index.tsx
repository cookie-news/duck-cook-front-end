...
const AddIngredient = ({onChange = () => {}, ...props}) => {
    ...
    let [ingredientEdit, setIngredientEdit] = useState(getDefaultIngredient());
    ...
    const saveEditIngredientItem = (ingredient:number) => {
        resetEditingIngredient();
    ...
    const ingredientFormMeasureOption = IngredientForm.find(x => x.name === 'measure').options;
                    ...
                    IngredientForm.map((form) => (
                        ...
                        ?
                            <TextField
                                ...
                                label={form.label}
                                defaultValue={ingredientEdit[form.name] || ''}
                                ...
                                <Card className={(ingredient.isEdit ? 'editing-item' : '') + ' card-border-top mt-4'}>
                                    <CardContent className="flex justify-between">
                                        <div>
                                            ...
                                            <Typography variant="h6" component="div">
                                                {(ingredientFormMeasureOption.find(x => x.value == ingredient.measure).label)}
                                            </Typography>
                                        </div>
                            ...
                            <Table aria-label="customized table">
                                ...
                                {ingredients.map((ingredient:any, ingredientIndex:number) => (
                                    <TableRow className={ingredient.isEdit ? 'editing-item' : ''} key={crypto.randomUUID()+ingredient.name}>
                                        ...
                                        <TableCell align="left">{(ingredientFormMeasureOption.find(x => x.value == ingredient.measure).label)}</TableCell>
